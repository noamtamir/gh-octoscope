...
func main() {
	...
	var prodLogger = flag.Bool("prod-log", false, "Production structured log")
	var csvFile = flag.Bool("csv", false, "Generate csv report")
	var htmlFile = flag.Bool("html", false, "Generate html report")
	var from = flag.String("from", "", "Generate report from this date. Format: YYYY-MM-DD")
	flag.Parse()

	// logging
	logger = CreateLogger(prodLogger)
